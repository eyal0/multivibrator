...
write_add_tool_change("back.ngc", "trace milling tool")
write_modify_tool_change("drill.ngc")
write_add_tool_change("outline.ngc",
                       "cutter, diameter " +
                       str(eval(get_millproject()["cutter-diameter"])) +
                       " " +
                       ("inch"
                        if ("metric" not in get_millproject()
                            or not eval(get_millproject()["metric"].title()))
                        else "mm"))
